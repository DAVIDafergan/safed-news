        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
          ...
          <aside className="lg:w-1/3 flex flex-col gap-12">
            ...
            <div className="text-center group">
              ...
              <AdUnit ad={sidebarAd} label={false} className="my-0 w-full rounded-2xl shadow-lg group-hover:shadow-xl transition-shadow" />
            </div>
             ...
             {sidebarVideoAd && sidebarVideoAd.isActive && (
                <div className="text-center">
                  ...
                  <AdUnit ad={sidebarVideoAd} label={false} className="my-0 w-full rounded-2xl overflow-hidden shadow-xl border-2 border-gray-100" />
                </div>
             )}
